      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarContent">
          <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/module3">Code Analysis</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/module4">Learning Paths</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/module5">Progress Monitoring</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/module6">Community Interaction</Link>
                </li>
                <li className="nav-item">
        ...
        <Routes>
          ...
          <Route path="/module1/InteractiveTools" element={<InteractiveTools />} />
